...
<head>
    <meta charset="utf-8">
    <title>SNC Asia - Capital Market & M&A</title>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-9">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 animated slideInDown">
                                        ...
                                        <a href="contact.html" class="btn btn-outline-light py-3 px-5"> Contact Us </a>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">SNC Asia</a>, All Right Reserved.
                </div>
