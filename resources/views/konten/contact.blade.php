...
@section('content')
@php
    $headerPath = $settings?->header_kontak_path ?: $settings?->header_home_path;
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p class="d-inline-block border rounded text-gold fw-semi-bold py-1 px-3">Contact</p>
                    <h1 class="display-5 mb-4">If You Have Any Query, Please Contact Us</h1>
                    <p class="mb-4">Silakan kirim pertanyaan atau kebutuhan Anda melalui form di bawah ini.</p>
                    @if (session('success'))
                        <div class="alert alert-success">{{ session('success') }}</div>
                    @endif
                    @if ($errors->any())
                        <div class="alert alert-danger">Mohon periksa kembali form Anda.</div>
                    @endif
